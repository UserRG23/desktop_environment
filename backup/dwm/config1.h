...
static const char *fonts[]          = { "JetBrainsMonoNL NFP:size=10:style=Bold",
"Font Awesome 6 Free Solid:size=8"};
static const char dmenufont[]       = "JetBrainsMonoNL NFP:size=10:style=Bold" ;
static const char col_gray1[]       = "#1f1f1f";        /* цвет col_gray1 */
static const char col_gray2[]       = "#c0b18b";        /* цвет col_gray2 */
static const char col_gray3[]       = "#c0b18b";        /* цвет col_gray3 */
static const char col_gray4[]       = "#1f1f1f";        /* цвет col_gray4 */
static const char col_cyan[]        = "#d17b49";        /* цвет col_cyan */static const char *colors[][3]      = {
	/*               fg         bg         border   */
